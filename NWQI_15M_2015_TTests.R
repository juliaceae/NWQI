...
##################################################################################
#Are any trends getting better after BMP implementation?
...
# 0.1578175 
# Conclusion: Post-implementation LRBS values could be less than or equal to Pre-implementation LRBS values.
# This is not as expected.
# Values are not getting significantly larger, as we had hoped to see post implementation.
...
# t = -0.17097, df = 11, p-value = 0.5663
...
#   mean of the differences 
# -0.4796667
# Conclusion: Post-implementation percent sand and fines values could be greater than or equal to Pre-implementation percent sand and fines values.
# This is not as expected.
# Values are not getting significantly smaller, as we had hoped to see post implementation.
...
# Values are getting signifcantly larger (worse) over time.  
...
#################################
#Are trends getting worse post BMP implmentation?
...
#   mean of the differences 
# 0.1578175 
# Conclusion: Post-implementation LRBS values could be greater than or equal to Pre-implementation LRBS values.
# At least values are not getting smaller (further from zero). 
...
#   mean of the differences 
# -0.4796667 
# Conclusion: Post-implementation Percent SAFN values could be less than or equal to Pre-implementation Percent SAFN values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# -3.3502 
# Conclusion: Post-implementation Percent Sand values could be less than or equal to Pre-implementation Percent Sand values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# 5.4948 
# Conclusion: Post-implementation Percent Fines values could be less than or equal to Pre-implementation Percent Fines values.
# At least values are not getting larger (further from zero). 
...
# !! The values are getting larger (further from zero). 
...
#   mean of the differences 
# 13.405 
# Conclusion: 2015 Wolman percent less than 1 mm values could be less than or equal to 1994 percent less than 1 mm values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# 9.155 
# Conclusion: 2015 Wolman percent sand and fines values could be less than or equal to 1994 percent sand and fines values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# 6.1525 
# Conclusion: 2015 Wolman percent gravel values could be less than or equal to 1994 percent gravel values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# -2.274545 
# Conclusion: 2015 Wolman D50 values could be less than or equal to 2000 Wolman D50 values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# 0.3545455 
# Conclusion: 2015 Wolman percent less than 1 mm values could be less than or equal to 2000 values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# -2.722727 
# Conclusion: 2015 Wolman percent sand and fines values could be less than or equal to 2000 values.
# At least values are not getting larger (further from zero). 
...
#   mean of the differences 
# -2.091818 
# Conclusion: 2015 Wolman percent gravel values could be less than or equal to 2000 values.
# At least values are not getting larger (further from zero). 
